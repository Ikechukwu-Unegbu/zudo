...
@section('content')
    <main id="main">
        ...
        <div class="container mb-5" style="margin-bottom: 5rem;">
            <form action="{{route('password.email')}}" method="POST" class="form mb-5 py-5">
                @csrf 
                ...
                <div class="form-group mt-3">
                    <label for="" class="form-label">Remember Password? </label>
                    <!-- <input type="checkbox" name="remember_me"> -->
                    <a href="{{route('login')}}">Login</a>
                </div> 
                <div class="form-group mt-4">
                    <button style="float:right;" class="btn btn-sm btn-primary">Send Link</button>
                </div>
            </form>
        </div>
