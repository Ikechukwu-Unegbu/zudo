                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $stats['totalusers'] }}"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $stats['trxvol'] }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Transactions</p>
                        </div>
                    </div><!-- End Stats Item -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $stats['branches'] }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Branches</p>
                        </div>
                    </div><!-- End Stats Item -->
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#faq-{{ $category->slug }}">
                                        <i class="bi bi-question-circle question-icon"></i>
                                        {{ $category->name }}
                                    </button>
                                </h3>
                                <div id="faq-{{ $category->slug }}" class="accordion-collapse collapse" data-bs-parent="#faqs">
